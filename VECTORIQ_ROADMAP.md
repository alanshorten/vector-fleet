...
*Last updated: June 2026 — Brain 1 (`utilisation.js`) extracted to `/calculations`; out-of-order upload handling and gap-month delta tolerance added as part of that work*
